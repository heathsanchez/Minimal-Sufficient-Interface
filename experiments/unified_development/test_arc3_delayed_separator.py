...
class World:
    ...
    def step(self, action):
        if self.phase < 2:
            ...
            raise ValueError('Unexpected extra action')
        return self.observe()
    def close(self):
        pass
...
class Tests(unittest.TestCase):
    ...
    def test_delayed_collision_requires_common_context(self):
        ...
        self.assertEqual(r['training_episodes'], 4)
        self.assertEqual(r['new_discoveries'] if 'new_discoveries' in r else 0, 0)
    def test_same_immediate_and_same_future_is_only_bounded_negative(self):
    ...
    def test_incomplete_pair_is_not_started(self):
        ...
        self.assertEqual(r['training_actions'], 0)
        self.assertEqual(r['attempted_pairs'], 0)
    ...
    def test_confirmation_mismatch_is_inconclusive(self):
        ...
        def replay(factory,path,expected,budget):
            ...
            return F_replay(world,path,expected,budget)
        F_replay = F.replay

...
def route(frontier: dict) -> str:
    ...
    if residual_type in {"ATTACHMENT", "REFRAME"} and "full_D_phase_frontier_closed" in promoted:
        ...
        if "mixed escape" in residual_text or "row-invariant" in residual_text or ("mixed" in residual_text and "diagonal-escape" in residual_text):
            return "SIZE_FREE_MIXED_DIAGONAL_ESCAPE"

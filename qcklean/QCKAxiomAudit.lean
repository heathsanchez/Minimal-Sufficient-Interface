...
/-!
# QCK v1 Dependency Audit

This file is intentionally executable documentation for the bounded QCK v1
public surface. CI compiles it after rejecting local placeholders or declarations without definitions.
The expected foundational dependencies are Lean/Mathlib quotient/extensionality
principles such as propext, Classical.choice, and Quot.sound; no unproved project-local declaration is permitted.
-/

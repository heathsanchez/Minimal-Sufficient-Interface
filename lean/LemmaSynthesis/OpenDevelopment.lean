...
private theorem obstructionTable3 :
  ...
  exact ⟨⟨0, 0, by decide⟩, ⟨⟨0, 1, by decide⟩, ⟨⟨0, 0, by decide⟩, ⟨⟨0, 0, by decide⟩, ⟨⟨0, 1, by decide⟩, ⟨⟨0, 0, by decide⟩, ⟨⟨0, 0, by decide⟩, ⟨⟨0, 1, by decide⟩, ⟨⟨0, 0, by decide⟩, ⟨⟨0, 0, by decide⟩, ⟨⟨0, 2, by decide⟩, ⟨⟨0, 0, by decide⟩, True.intro⟩⟩⟩⟩⟩⟩⟩⟩⟩⟩⟩⟩
